      ...
      options: {
        ...
        interactivity: {
          ...
          modes: {
            ...
            push: { default: true, groups: [], quantity: 3, },
            remove: { quantity: 2, },
        ...
        particles: {
          ...
          collisions: { absorb: { speed: 2, }, bounce: { horizontal: { random: { enable: false, minimumValue: 0.1, }, value: 1, }, vertical: { random: { enable: false, minimumValue: 0.1, }, value: 1, }}, enable: false, mode: "bounce", overlap: { enable: true, retries: 0, }},
          ...
          rotate: { random: { enable: true, minimumValue: 0, }, value: 0, animation: { enable: true, speed: 5, decay: 0, sync: false, }, direction: "random", path: false, }, destroy: { bounds: {}, mode: "none", split: { count: 1, factor: { random: { enable: false, minimumValue: 0, }, value: 3, }, rate: { random: { enable: false, minimumValue: 0, }, value: { min: 4, max: 9,arotate: { random: { enable: true, minimumValue: 0, }, value: 0, animation: { enable: true, speed: 5, decay: 0, sync: false, }, direction: "random", path: false, },
          destroy: { bounds: {}, mode: "none", split: { count: 1, factor: { random: { enable: false, minimumValue: 0, }, value: 3, }, rate: { random: { enable: false, minimumValue: 0, }, value: { min: 4, max: 9, }}, sizeOffset: true, particles: {}, }}, }}, sizeOffset: true, particles: {}, }},
...
<template>
  <Particles
    ...
    v-bind:particlesInit="particlesInit"
  />
</template>
