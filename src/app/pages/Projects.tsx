...
const projects = {
  ...
  iStylist: {
    ...
    application_url: 'https://seniorproject.sit.kmutt.ac.th/showproject/CS59-RE43',
    ...
    <div className="w-full max-w-7xl mx-auto p-6">
      ...
      >
        {Object.keys(projects).map((key) => {
          const { name, description, application_url, icon, source_url } = projects[key];
          return (
            <div
              key={key}
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-between">
                  {/* Project Name */}
                  <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-white">{name}</h3>

                  {/* Project Description */}
                  <p className="text-sm sm:text-base md:text-lg text-gray-400 mt-2">{description}</p>
